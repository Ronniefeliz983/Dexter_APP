...
# --------------------------
st.set_page_config(page_title="Dashboard Trabajos S - v2.7.7", layout="wide")
...
# (Movido a la parte superior para evitar NameError)
# ==============================================================================
...
# ==============================================================================
# --- SECCIÓN 2: SIDEBAR Y FILTROS (Movido antes de la lógica principal) ---
# ==============================================================================
...
# Llenar las opciones de filtro basado en los datos (df_supervisor_unicos_MASTER)
supervisor_options = ["Todos"]
estado_options = []

if df_supervisor_unicos_MASTER is not None and not df_supervisor_unicos_MASTER.empty:
    ...
    if 'Estado' in df_supervisor_unicos_MASTER.columns:
        # Las opciones de estado deben venir de la lista filtrada de hoy (df_unicos_base)
...
# ==============================================================================
# --- SECCIÓN 3: LÓGICA PRINCIPAL (v2.7.7 - CORREGIDO) ---
...
# ==============================================================================
# --- SECCIÓN 4: RENDERIZADO DE PÁGINAS ---
# ==============================================================================
