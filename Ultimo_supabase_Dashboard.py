...
# -----------------------------------------------
# --- SECCIÓN 1: DEFINICIÓN DE FUNCIONES DE AYUDA ---
# -----------------------------------------------
...
# --- FUNCIONES DE MANIPULACIÓN DE DATOS (MOVILIZADAS) ---
...
# Llenar las opciones de filtro basado en los datos de HOY (df_unicos_base)
...
if df_unicos_base is not None and not df_unicos_base.empty:
    if 'Supervisor' in df_unicos_base.columns:
        # Usamos df_supervisor_unicos_MASTER para las opciones, para que puedas ver a todos
...
# df_unicos ya está filtrado por supervisor (gracias a la lógica principal)
