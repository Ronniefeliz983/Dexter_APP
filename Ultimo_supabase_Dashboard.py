...
# --------------------------
st.set_page_config(page_title="Dashboard Trabajos S - v2.7.8", layout="wide")
...
# ==============================================================================
# --- SECCIÓN 2: LÓGICA PRINCIPAL (v2.7.7 - CORREGIDO) ---
# (Ahora que supervisor_sel está definido, podemos filtrar)
# ==============================================================================

# 1. Carga de datos ya está hecha (df_full_historial)
# 2. Estado más reciente ya está calculado (df_ultimo_estado_MASTER)
...
if df_full_historial is None or df_full_historial.empty:
    ...
    try:
        ...
        # PRIMERO creamos el sidebar para OBTENER 'supervisor_sel'
        ...
        # AHORA que tenemos 'supervisor_sel', filtramos el MASTER
        ...
        # 5. Llenar opciones de estado y crear el filtro de estado
        estado_options = []
...
# df_unicos: Filtrado final por estado (de la lógica "Pendientes + Cerrados Hoy")
...
if menu == "🏠 Principal":
    ...
    render_dashboard_page(
        ...
        df_full_historial=df_full_historial,
        df_unicos_para_buscar=df_supervisor_unicos_MASTER[(df_supervisor_unicos_MASTER['Es_PYME_Negocio'] == True) if 'Es_PYME_Negocio' in df_supervisor_unicos_MASTER else False],
        role=st.session_state.user_role,
        role_supervisor_id=st.session_state.supervisor_id,
        global_supervisor_sel=supervisor_sel,
        status_filter=estatus_sel,
